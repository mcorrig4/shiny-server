...
```{r SETTING UP ENVIRONMENT, echo=FLASE}
#Clear environment
rm(list=ls()) 

#Chicago Crime Statistics 2001 to Present
libs <- c("lubridate", "dplyr", "ggplot2", "leaflet", "ggmap", "readr", "rgdal", "sp", "tigris", "acs", "stringr")
lapply(libs, install.packages, character.only = TRUE)
lapply(libs, library, character.only = TRUE)

ChiCrimeDF <- read_csv("~/Dropbox/MSC 2017/BStat/Stat_Project/DataFiles/Crimes_-_2001_to_present.csv")
...
```{r MAP PLOTTING}
# Leaflet - plotting Chicago Map
# ======================
# 
# map.chicago <- leaflet(options = leafletOptions(minZoom = 12, maxZoom = 18)) %>% 
#   fitBounds(-87.73949,41.79613,-87.51977,41.95973) %>% 
#   addTiles() 
#   
# map.chicago
